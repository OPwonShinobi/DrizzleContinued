			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="leaderboard-filter col-xs-12">
						...
						<div class="col-sm-2">
							<input type="text" class="form-control order-alpha" id="nameFilter-city" onkeyup="nameOnkeyup(this.id)" placeholder="By Name" title="Type in a name">
						</div>
						<div class="col-sm-2">
							<input type="text" class="form-control order-alpha" id="schoolFilter-city" onkeyup="schoolOnkeyup(this.id)" placeholder="By School" title="Type in a school">
						</div>
						<div class="col-sm-2">
							<input type="text" class="form-control order-alpha" id="scoreFilter-city" onkeyup="scoreOnkeyup(this.id)" placeholder="By Score" title="Type in a score">
						</div>
